...
public class TinyDB {
    ...
    public ArrayList<UpdateDishModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<UpdateDishModel> playerList =  new ArrayList<UpdateDishModel>();

        for(String jObjString : objStrings){
            UpdateDishModel player  = gson.fromJson(jObjString,  UpdateDishModel.class);
    ...
    public void putListObject(String key, ArrayList<UpdateDishModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(UpdateDishModel player: playerList){
